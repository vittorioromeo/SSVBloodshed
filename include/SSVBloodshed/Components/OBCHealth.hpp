...
public:
    ...
    bool damage(sses::EntityStat mAttackerStat, OBCActorND* mAttacker,
    float mAmount) noexcept;
    inline void setHealth(float mHealth) noexcept
    {
        health = ssvu::getClamped(mHealth, 0.f, maxHealth);
    }
