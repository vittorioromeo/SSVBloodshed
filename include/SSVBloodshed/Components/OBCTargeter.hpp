...
namespace ob
{
    ...
    public:
        OBCTargeter(Entity& mE, OBCPhys& mCPhys, OBGroup mTargetGroup) noexcept
        ...
        inline void update(FT) override
        {
            ...
            {
                distance =
                    ssvs::getDistEuclidean(target->getPosF(), cPhys.getPosF());
        ...
        {
            return target != nullptr && manager.isAlive(targetStat);
        }
