	...
	template<typename TGame , typename TLevel, typename TTile, typename TFactory> class OBLEDatabaseImpl
	{
		...
		public:
			inline OBLEDatabaseImpl(OBAssets& mAssets, TGame* mGame = nullptr) : a(mAssets), game{mGame}
			{
				...
				add(OBLETType::LETRunner,			a.txSmall,		a.e1Stand,				{{"rot", 0}},				[this](TLevel&, TTile&, const Vec2i& mP){ f->createERunner(mP, RunnerType::Unarmed); });
				add(OBLETType::LETRunnerArmed,		a.txSmall,		a.e1Shoot,				{{"rot", 0}},				[this](TLevel&, TTile&, const Vec2i& mP){ f->createERunner(mP, RunnerType::PlasmaBolter); });
				add(OBLETType::LETCharger,			a.txMedium,		a.e2Stand,				{{"rot", 0}},				[this](TLevel&, TTile&, const Vec2i& mP){ f->createECharger(mP, ChargerType::Unarmed); });
				add(OBLETType::LETChargerArmed,		a.txMedium,		a.e2Shoot,				{{"rot", 0}},				[this](TLevel&, TTile&, const Vec2i& mP){ f->createECharger(mP, ChargerType::PlasmaBolter); });
				add(OBLETType::LETJuggernaut,		a.txBig,		a.e3Stand,				{{"rot", 0}},				[this](TLevel&, TTile&, const Vec2i& mP){ f->createEJuggernaut(mP, JuggernautType::Unarmed); });
				add(OBLETType::LETJuggernautArmed,	a.txBig,		a.e3Shoot,				{{"rot", 0}},				[this](TLevel&, TTile&, const Vec2i& mP){ f->createEJuggernaut(mP, JuggernautType::PlasmaBolter); });
				add(OBLETType::LETGiant,			a.txGiant,		a.e4Stand,				{{"rot", 0}},				[this](TLevel&, TTile&, const Vec2i& mP){ f->createEGiant(mP); });
				add(OBLETType::LETBall,				a.txSmall,		a.eBall,				{},							[this](TLevel&, TTile&, const Vec2i& mP){ f->createEBall(mP, BallType::Normal, false); });
				add(OBLETType::LETBallFlying,		a.txSmall,		a.eBallFlying,			{},							[this](TLevel&, TTile&, const Vec2i& mP){ f->createEBall(mP, BallType::Flying, false); });
				...
				[this](TLevel&, TTile& mT, const Vec2i& mP)
				{
					f->createForceField(mP, getP<int>(mT, "id"), getDir8FromDeg(getP<float>(mT, "rot")), getP<bool>(mT, "blockFriendly"), getP<bool>(mT, "blockEnemy"), getP<float>(mT, "forceMult") / 100.f);
				});

				add(OBLETType::LETBulletForceField,	a.txSmall,		a.forceArrowMark,		{{"id", 0}, {"rot", 0}, {"blockFriendly", true}, {"blockEnemy", true}},
				[this](TLevel&, TTile& mT, const Vec2i& mP)
				{
					f->createBulletForceField(mP, getP<int>(mT, "id"), getDir8FromDeg(getP<float>(mT, "rot")), getP<bool>(mT, "blockFriendly"), getP<bool>(mT, "blockEnemy"));
				});

				add(OBLETType::LETPjBooster,	a.txSmall,			a.fpj0,					{{"id", 0}, {"rot", 0}, {"forceMult", 100.f}},
				[this](TLevel&, TTile& mT, const Vec2i& mP)
				{
					f->createBooster(mP, getP<int>(mT, "id"), getDir8FromDeg(getP<float>(mT, "rot")), getP<float>(mT, "forceMult") / 100.f);
				});

				add(OBLETType::LETPjChanger,	a.txSmall,			a.bulletChanger,		{{"id", 0}, {"rot", 0}},
				[this](TLevel&, TTile& mT, const Vec2i& mP)
				{
					f->createBooster(mP, getP<int>(mT, "id"), getDir8FromDeg(getP<float>(mT, "rot")), 0.f);
				});
			}
