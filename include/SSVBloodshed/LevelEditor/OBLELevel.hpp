...
public:
    ...
    inline void draw(sf::RenderTarget& mRenderTarget, bool mOnion, bool mShowId,
    int mCurrentZ = 0)
    {
        ...
        for(auto& t : tiles) {
            ...
            if(mOnion)
                ...
                255, 255, 255,
                ssvu::getClamped(
                255 - std::abs(t.second.getZ() - mCurrentZ) * 50, 0, 255)));
    ...
    {
        return mX >= 0 && mY >= 0 && mZ >= -depth && mX < cols && mY < rows &&
               mZ < depth;
    }
