...
namespace GUI
{
    namespace Impl
    {
        ...
        private:
            ...
            {
                str.erase(
                std::begin(str) + getIdxMin(), std::begin(str) + getIdxMax());
                setBoth(getIdxMin());
            }
            ...
            inline void move(bool mShift, bool mCtrl, int mDir)
            {
                ...
                else if(!isSingle())
                {
                    if(mCtrl) {
                        ...
                        setBoth(mDir > 0 ? getIdxMax() + 1 : getIdxMin() - 1);
                }
                else
                {
                    if(mCtrl) {
        ...
        public:
            ...
            inline void refreshShape(
            TextCursor& mTextCursor, float mLeft, float mY, float mSpacing)
            {
