...
namespace ob
{
    ...
    public:
        ...
        inline static const Trigger& getTRight() noexcept
        {
            return get().tRight;
        }
        inline static const Trigger& getTUp() noexcept { return get().tUp; }
        inline static const Trigger& getTDown() noexcept { return get().tDown; }
        inline static const Trigger& getTShoot() noexcept
        {
            return get().tShoot;
        }
        inline static const Trigger& getTSwitch() noexcept
        {
            return get().tSwitch;
        }
        ...
        inline static SizeT getParticleMax() noexcept
        {
            return get().particleMax;
        }
        ...
        inline static bool isSoundEnabled() noexcept
        {
            return get().soundEnabled;
        }
        inline static bool isMusicEnabled() noexcept
        {
